...
if __name__ == "__main__":
    ...
    base_april = navigation.base_duration_days("R_MAL_CAL", date(1498, 4, 24))
    ...
    print(f"Duração-base calibrada 1498-04-24: {base_april:.1f} dias")
    print(f"Estimativa com ruído 1498-04-24: {april:.1f} dias ({monsoon_phase(date(1498, 4, 24)).value})")
    print(f"Estimativa com ruído 1498-06-24: {june:.1f} dias ({monsoon_phase(date(1498, 6, 24)).value})")
